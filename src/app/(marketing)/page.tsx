...
export default function MarketingPage() {
  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden w-full max-w-full">
      ...
      <div className="relative w-full mt-[-71vh] md:mt-[-15vh] z-25 pb-[20vh] md:pb-0 portrait:mt-[-71svh]">
        <CloudTransition />
      </div>
      ...
      <div id="music-section">
        <LandingMusicSection className="-mt-[80vh] md:-mt-[210vh] portrait:-mt-[80svh]" />
      </div>
      ...
      >
        ...
        <div
          id="shop-section"
          className="absolute top-[58vh] left-0 right-0 mx-auto w-screen h-auto z-999 md:top-[19vh] md:right-[-60vw] md:w-[65vw] md:h-auto animate-float-pulse cursor-pointer portrait:top-[58svh]"
