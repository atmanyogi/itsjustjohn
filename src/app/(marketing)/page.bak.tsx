...
export default function MarketingPage() {
  ...
  return (
    <main className="relative h-full overflow-x-hidden w-full max-w-full">
      ...
      <div className="relative w-full mt-[-71svh] md:mt-[-15vh] z-25">
        <CloudTransition />
      </div>
      ...
      >
        ...
        <Image
          ...
          className="absolute -bottom-[-20.75vh] md:-bottom-[-62vh] left-0 w-full h-auto object-cover z-10" // Moved down about 1 3/4 pages on mobile, slightly adjusted desktop position
          draggable={false}
          loading="lazy"
        ...
        <div
          id="shop-section"
          className="absolute top-[18svh] left-0 right-0 mx-auto w-screen h-auto z-999 md:top-[19vh] md:right-[-60vw] md:w-[65vw] md:h-auto animate-float-pulse cursor-pointer"
      ...
      <div className="relative w-full hidden md:block md:-mt-[96vh]">
        ...
        <Image
          ...
          width={1920}
          height={1080}
          className="absolute bottom-0 left-0 w-full h-auto object-cover z-35 pointer-events-none"
      ...
      {/* Bottom layer with layers 2.png - Mobile Only (Completely Removed PullApartReveal and optimized heights) */}
      <div className="relative w-full block md:hidden -mt-[48svh] z-10">
        <Image
      ...
      {/* Jar Bottom */}
      <div className="relative w-full -mt-[24svh] md:-mt-[31.25vh] z-20 md:z-60 -mb-[38.75svh] md:mb-0">
        <Image
          src="/jar bottom.png"
          alt="Jar Bottom"
          width={1920}
        ...
        <div className="absolute bottom-[18%] left-0 right-0 mx-auto w-full flex justify-center items-center gap-8 md:gap-12 z-100">
          ...
          <a 
            href="#" 
            className="text-white hover:opacity-80 transition-opacity cursor-default"
            aria-label="Facebook"
          >
            <FaFacebook className="w-7.5 h-7.5 md:w-15 md:h-15" />
          </a>
          <a 
            href="#" 
            className="text-white hover:opacity-80 transition-opacity cursor-default"
          ...
          >
            <FaXTwitter className="w-7.5 h-7.5 md:w-15 md:h-15" />
          </a>
          <a 
            href="#" 
            className="text-white hover:opacity-80 transition-opacity cursor-default"
